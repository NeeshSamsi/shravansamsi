...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 flex items-center justify-between py-8 px-4 sm:px-8 md:px-12 lg:px-32 xl:px-44 2xl:px-56 3xl:mx-auto 3xl:max-w-[144rem] 3xl:px-0">
